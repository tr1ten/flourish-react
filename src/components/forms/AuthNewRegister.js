...
function AuthNewRegister(props) {
  ...
  const validationSchema = Yup.object().shape({
    ...
    email: Yup.string()
      .email()
      .businessEmail("Email must match with the entered business domain.")
        ...
        onSubmit={async (values, { setErrors, setStatus, setSubmitting }) => {
          try {
            const response = await axios.post(
              "https://api.flourish.us/auth/signup",
              values
            );
            ...
            if (response?.data?.success) {
              ...
              if (saveData) {
                window.location.replace(
                  `https://www.app.flourish.us/${saveData.company_name}/create-password/${saveData._uuid}`
                );
              } else {
          ...
          <div className={Styles.section}>
            {props.activeForm === 1 ? (
                  ...
                  <div className={Styles.input}>
                    <FormControl fullWidth>
                      ...
                      <OutlinedInput
                        ...
                        startAdornment={
                          <>
                            <Typography>https://www.</Typography>
                          </>
                        }
                        endAdornment={
                          <InputAdornment position="end">
              ...
              <>
                ...
                <p className={Styles.heading}> Admin Contact Details</p>
                <div className={Styles.inputs}>
